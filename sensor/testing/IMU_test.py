...
#print(pi.bb_i2c_zip(SDA, [ADDRESS,1,START,WRITE,1,((i2c_address<<1)|WRITE_MASK),WRITE,1,ST_RESULT_ADDRESS,START,WRITE,1,((i2c_address<<1)|READ_MASK),READ,1,STOP]))
print(pi.bb_i2c_zip(SDA, [ADDRESS,i2c_address,START,WRITE,1,((i2c_address<<1)|WRITE_MASK),STOP]))
